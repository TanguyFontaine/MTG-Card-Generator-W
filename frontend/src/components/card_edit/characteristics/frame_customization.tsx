   ...
   return (
      <VStack spacing={4} align="stretch">
         ...
         <VStack spacing={2} align="stretch">
            <Text color="brand.textSecondary">Frame type:</Text>
            <RadioGroup
               value={state.frameType}
               setValue={(value) =>
                  dispatch({ name: CardActionName.setFrameType, data: value as FrameType })
               }
            >
               <Stack direction="row" spacing={4}>
                  <Radio value={FrameType.Normal} displayLabel="Normal" />
                  <Radio value={FrameType.LevelUp} displayLabel="Level Up" />
               </Stack>
            </RadioGroup>
         </VStack>
